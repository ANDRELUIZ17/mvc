...
import com.desafiomvc.services.ReceitaService;
...
public class ReceitaController {
    ...
    public ModelAndView editarReceita(@RequestParam(required = false) Long id) {
         ...
         mv.addObject("listaUnidadeDeMedida", unidadeDeMedidaService.listarUnidadeDeMedida());
    ...
    public ModelAndView listarReceita(){
        ...
        mv.addObject("lista", receitaService.listarReceitas());
